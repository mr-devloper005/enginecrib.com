export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'enginecrib',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'EngineCrib',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'enginecrib.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://enginecrib.com',
